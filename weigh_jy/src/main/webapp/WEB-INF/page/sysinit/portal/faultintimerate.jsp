...
<script type="text/javascript">
	...
	*/
	...
	var chartpanel = {
			xtype:'estchartpanel',
			region:'fit',
			chartUrl:'<%=basePath%>est/sysinit/portal/FaultPortal/getFaultIntimeRateForChart',
			id:'chartpanel',
			title:'图表',
			autoScroll :true
		}
	...
	var gridpanel = {
		...
		id: 'gridpanel',
		items: [
			{xtype: 'estgrid', id:'grid',storeurl: '<%=basePath%>est/sysinit/portal/FaultPortal/getFaultIntimeRateForGrid', colstype: colsType, region: 'center'}
		]
	};
