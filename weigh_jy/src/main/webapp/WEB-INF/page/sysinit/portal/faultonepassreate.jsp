...
<script type="text/javascript">
	...
	*/
	...
	function showChart(chartType) {
		...
		var condition={startTime:startTime,endTime:endTime,deptName:deptName,faultType:faultType,distence:distence}
	...
	var chartpanel = {
			xtype:'estchartpanel',
			region:'fit',
			chartUrl:'<%=basePath%>est/sysinit/portal/FaultPortal/getFaultOnepassRateForChart',
			id:'chartpanel',
			title:'图表',
			autoScroll :true
		}
	...
	var colsType = {
				cols: [
						...
						{dataIndex:'onepassAmount', header: '一次通过的数',width: 40},
						{dataIndex:'faultfinishTotal', header: '完成的总数',width: 40},
						{dataIndex:'onepassreate',header:'一次通过率(%)',width:40,renderer:function(v){
	...
	var gridpanel = {
		...
		id: 'gridpanel',
		items: [
			{xtype: 'estgrid', id:'grid',storeurl: '<%=basePath%>est/sysinit/portal/FaultPortal/getFaultOnepassRateForGride', colstype: colsType, region: 'center'}
		]
	};
	...
	var Search = function(){
		...
		var condition={startTime:startTime,endTime:endTime,deptName:deptName,faultType:faultType}
