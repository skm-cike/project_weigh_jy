	...
	Ext.onReady(function(){
		...
		*/
		var formcols = [{id:'userid',fieldset:'详细',
			items: [
					...
					{fieldLabel:'生日',xtype:'estdatetime',name:'birthday',format:'Y-m-d H:i',altFormats:'Y-m-d|Y-m-d H:i:s'},
		...
		*/
		var gridPanel = {
			...
			items: [
				{xtype: 'estgrid', id:'grid', groupField:'sysDept.deptname',storeurl: '<%=basePath%>est/sysinit/sysuser/SysUser/getUserList', colstype: colsType, region: 'center'}, searchPanel
			]
		};
				...
				ctx: {url: '<%=basePath%>est/sysinit/sysdept/SysDept', method: 'Dept', ctxitems:[{id:'add',text:'添加'},{id:'modify',text:'修改'},{id:'delete',
					...
					formitems:
					 ...
					 items:[{fieldLabel:'部门名称',name:'deptname',allowBlank: false},
							...
							{fieldLabel:'部门编号',name:'deptcode',xtype:'hidden'},
							{fieldLabel:'序号',name:'deptorder'}
						]}]}
				};
		/*
			Viewport组件，包括：
