...
/**
 * Est.ux.DatetimeField
 * xtype is estdatetime
 * @version 1.0
 * 
 */
/********** CONSTRUCTOR ******
 ...
 ****/
Est.ux.DatetimePicker = function(config){
	/** Call superclass constructor **/
	Est.ux.DatetimePicker.superclass.constructor.call(this, config);
};

Ext.extend(Est.ux.DatetimePicker, Ext.DatePicker, {
	...
	*/
    ...
    handleDateClick : function(e, t){
 	...
 	onRender : function(container, position){
		...
		m[m.length] = '</tr></tbody></table></td></tr><tr><td class="minutecss">';
		m[m.length] = '<table cellspacing="0" ><tr>';
		m[m.length] = '<td class="y-hour-middle" align="center" rowspan=2></td><td class="y-hour-left"><a href="#" title="down"></a></td>';
		m[m.length] = '<td class="y-minute-middle" align="center" rowspan=2></td><td class="y-minute-left"><a href="#" title="down"> </a></td>';
		m[m.length] = '</tr><tr><td class="y-hour-right"><a href="#" title="up"> </a></td><td class="y-minute-right"><a href="#" title="up"> </a></td></tr></table></td><td  colspan="2" class="x-date-bottom" align="center"></td></tr></table><div class="x-date-mp"></div>';
 ...
 * Contains: Est.ux.DatetimePicker
 * Purpose: Effectively overrides Ext.menu.DateItem so that it contains Est.ux.DatetimePicker instead of Ext.DatePicker
 * Note: ORIGINAL and NEW comments are used to denote what differs from Ext.menu.DateItem
 */
Est.ux.DatetimeItem = function(config){
	// ORIGINAL:
	//Ext.menu.DateItem.superclass.constructor.call(this, new Ext.DatePicker(config), config);
	// NEW:
	Est.ux.DatetimeItem.superclass.constructor.call(this, new Est.ux.DatetimePicker(config), config);
	// END NEW
...
Ext.extend(Est.ux.DatetimeItem, Ext.menu.Adapter, {
	onSelect : function(picker, date){
		this.fireEvent("select", this, date, picker);
		// ORIGINAL:
		//Ext.menu.DateItem.superclass.handleClick.call(this);
		// NEW:
		Est.ux.DatetimeItem.superclass.handleClick.call(this);
		// END NEW
	}
});
 ...
 */
Est.ux.DatetimeMenu = function(config){
	// ORIGINAL:
	//Ext.menu.DateMenu.superclass.constructor.call(this, config);
	//this.plain = true;
	//var di = new Ext.menu.DateItem(config);
	// NEW:
	Est.ux.DatetimeMenu.superclass.constructor.call(this, config);
	this.plain = true;
	var di = new Est.ux.DatetimeItem(config);
	// END NEW
	this.add(di);
	this.picker = di.picker;
	this.relayEvents(di, ["select"]);
};
Ext.extend(Est.ux.DatetimeMenu, Ext.menu.Menu);

Est.ux.DatetimeField = function(config){
	this.menu = new Est.ux.DatetimeMenu();
	Est.ux.DatetimeField.superclass.constructor.call(this, config);
}

Ext.extend(Est.ux.DatetimeField,Ext.form.DateField);


Ext.reg('estdatetime',Est.ux.DatetimeField);
