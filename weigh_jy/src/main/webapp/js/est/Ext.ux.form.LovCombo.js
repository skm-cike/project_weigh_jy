 ...
 * @date      16. April 2008
 * @version   $Id: Ext.ux.form.LovCombo.js,v 1.1 2014/12/22 01:37:13 luh Exp $
 *
 ...
 */
Ext.ux.form.LovCombo = Ext.extend(Est.ux.PropertyComboBox, {
	...
	,getCheckedValue:function(field) {
		...
		snapshot.each(function(r) {
			if(r.get(this.checkField)) {
				//this.view.addRowClass(this.store.indexOf(r), 'x-grid-record-add');
				//this.store.indexOf(r).addClass('x-grid-record-add');
				c.push(r.get(field));
			}
		}, this);
