 ...
 */ 
 Est.ux.CustomToolbar = function(config){
    if(Ext.isArray(config)){
        config = {buttons:config};
    }
    this.trMaxLength = 20;
     Est.ux.CustomToolbar.superclass.constructor.call(this, config);
};

(function(){

var T =  Est.ux.CustomToolbar;
...
Ext.extend(T, Ext.BoxComponent, {
    ...
    autoCreate: {
        ...
        html:'<table cellspacing="0"><tr></tr></table><table cellspacing="0"><tr></tr></table>'
    },

    // private
    onRender : function(ct, position){
        this.el = ct.createChild(Ext.apply({ id: this.id },this.autoCreate), position);
       // this.tr1 = this.el.child("tr", true);
       // this.tr2 = Ext.get(this.tr1).next("tr",true);
       //this.tr1 = this.el.child("tr",true);
       
      // this.tr2 = this.el.child("tr",true);
        //alert(tr2.id);
        
        this.tr1 = this.el.child("table").child("tr",true);
        this.tr2 = this.el.child("table").next("table").child("tr",true);
    ...
    insertButton : function(index, item){
        ...
        if(Ext.get(this.tr1).getSize<this.trMaxLength) {
        	this.tr1.insertBefore(td, this.tr1.childNodes[index]);
        } else {
        	this.tr2.insertBefore(td, this.tr2.childNodes[index-this.trMaxLength]);
        }
    ...
    nextBlock : function(){
        ...
        if(this.tr1.childNodes.length<this.trMaxLength){
    ...
    onDestroy : function(){
        ...
        if(this.rendered){
            ...
            Ext.Element.uncache(this.tr1);
            Ext.Element.uncache(this.tr2);
        }
    },
...
Ext.reg('customtoolbar',  Est.ux.CustomToolbar);
...
Ext.reg('ctbseparator', T.Separator);
...
Ext.reg('ctbsplit', T.SplitButton);
// backwards compat
